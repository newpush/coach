<template>
  <UCard
    :class="[
      canClick
        ? 'hover:shadow-md hover:ring-1 hover:ring-gray-300 dark:hover:ring-gray-600 cursor-pointer transition-all duration-200'
        : ''
    ]"
    ...
    <div class="flex items-center justify-between">
      <div class="flex-1">
        <div class="flex items-center gap-2 mb-2">
          <UIcon v-if="icon" :name="icon" :class="['w-5 h-5', iconColorClass]" />
        ...
        <div class="mt-3">
          <UProgress :model-value="score ? score * 10 : 0" size="sm" :color="progressColor" />
        </div>
