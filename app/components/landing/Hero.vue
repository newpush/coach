      ...
      <div class="mx-auto mt-16 flex max-w-2xl sm:mt-24 lg:ml-10 lg:mt-0 lg:mr-0 lg:max-w-none lg:flex-none xl:ml-32">
        <div class="max-w-3xl flex-none sm:max-w-5xl lg:max-w-none">
          <div class="-m-2 rounded-xl bg-gray-900/5 p-2 ring-1 ring-inset ring-gray-900/10 lg:-m-4 lg:rounded-2xl lg:p-4">
            <div class="relative rounded-md shadow-2xl ring-1 ring-gray-900/10 overflow-hidden bg-gray-800 border border-gray-700 tilt-card group">
               <div class="aspect-[16/10] w-[40rem] bg-gray-900/95 relative overflow-hidden">
                  
                  <div class="h-12 border-b border-gray-700 flex items-center justify-between px-4 bg-gray-800/50 backdrop-blur">
                  ...
                  <div class="p-6 grid grid-cols-12 gap-6 h-full">
                     ...
                     <div class="col-span-1 flex flex-col items-center space-y-6 pt-4 text-gray-600">
                        ...
                        <UIcon name="i-heroicons-chart-bar" class="w-6 h-6 hover:text-gray-400 transition-colors" />
                        <UIcon name="i-heroicons-calendar" class="w-6 h-6 hover:text-gray-400 transition-colors" />
                     ...
                     <div class="col-span-11 grid grid-cols-2 gap-6">
                        ...
                        <div class="col-span-2 bg-gray-800/50 rounded-xl border border-gray-700/50 p-4 relative overflow-hidden hover:border-primary-500/30 transition-colors group/card">
                           ...
                           <div class="text-sm text-gray-400 font-mono leading-relaxed h-12 relative">
                              <span class="typing-text">Recovery is low (34%). Switching intervals to Zone 2...</span>
                              <span class="cursor inline-block w-2 h-4 bg-primary-500 ml-1 animate-pulse"></span>
                           </div>
                        </div>

                        <div class="bg-gray-800/50 rounded-xl border border-gray-700/50 p-4 hover:bg-gray-800 transition-colors">
                        ...
                        <div class="col-span-2 bg-gray-800/30 rounded-xl border border-gray-700/30 h-32 relative overflow-hidden group-hover:border-gray-700/50 transition-colors">
                           <div class="absolute inset-0 opacity-10 bg-[url('https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExbm95MXY4Z3Y0Z3Y0Z3Y0Z3Y0Z3Y0Z3Y0Z3Y0Z3Y0Z3Y0Z3Y0/U3qYN8S0j3bpK/giphy.gif')] bg-cover mix-blend-screen pointer-events-none"></div>
                           
                           <svg class="absolute bottom-0 left-0 right-0 h-full w-full" preserveAspectRatio="none">
                              <path d="M0,80 C100,70 200,90 300,50 C400,10 500,60 600,40 L600,128 L0,128 Z" fill="url(#gradient)" opacity="0.2" />
                              <path d="M0,80 C100,70 200,90 300,50 C400,10 500,60 600,40" stroke="#10b981" stroke-width="2" fill="none" class="drop-shadow-lg" />
                              <defs>
