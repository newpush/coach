<template>
  <div class="my-4 bg-gray-50 dark:bg-gray-900 rounded-lg p-4 border border-gray-200 dark:border-gray-700">
...
const chartOptions = computed(() => ({
  ...
  scales: props.chartData.type !== 'doughnut' && props.chartData.type !== 'radar' ? {
    x: {
      grid: {
