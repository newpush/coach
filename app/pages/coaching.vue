        ...
        <div class="p-4 sm:p-6 space-y-4 sm:space-y-6">
            ...
            >
              <template #header>
                <div class="flex items-start justify-between">
                  ...
                  <UBadge
                    v-if="rel.athlete.currentRecommendation"
                    :color="
                      getRecommendationColor(rel.athlete.currentRecommendation.recommendation)
                    "
                    size="xs"
                  >
              ...
              <div class="grid grid-cols-2 gap-4 my-2">
                <div class="bg-neutral-50 dark:bg-neutral-800/50 p-3 rounded-lg text-center">
                  ...
                  <p class="text-xl font-bold text-primary-600 dark:text-primary-400">
                    {{ rel.athlete.currentFitnessScore || 'N/A' }}
                  </p>
                </div>
                <div class="bg-neutral-50 dark:bg-neutral-800/50 p-3 rounded-lg text-center">
          ...
          >
            ...
            <p class="text-neutral-500 mb-6 max-w-xs">
              Connect with athletes using their invite codes to start coaching.
            </p>
            <UButton
              color="primary"
...
<script setup>
  ...
  useHead({
    ...
    meta: [
      {
        name: 'description',
        content: 'Manage your athletes, monitor their progress, and send messages.'
      }
    ]
  })
